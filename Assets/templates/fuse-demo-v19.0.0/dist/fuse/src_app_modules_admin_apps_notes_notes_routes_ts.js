...
class NotesDetailsComponent {
  ...
  ngOnInit() {
    ...
    this.noteChanged.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_4__.takeUntil)(this._unsubscribeAll), (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.debounceTime)(500), (0,rxjs__WEBPACK_IMPORTED_MODULE_6__.switchMap)(note => this._notesService.updateNote(note))).subscribe(() => {
      // Mark for check
...
/* harmony export */ });
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! lodash-es */ 48717);
