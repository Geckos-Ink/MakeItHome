...
export class FuseVerticalNavigationComponent implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
    ...
    private _showAsideOverlay(): void
    {
        ...
        $('.fuse-vertical-navigation-content').css('background-color','rgba(0,0,0,1)')
        $('.fuse-vertical-navigation-content').css('color','white')
    ...
    private _hideAsideOverlay(): void
    {
        ...
        $('.fuse-vertical-navigation-content').css('background-color','rgba(0,0,0,0)')
        $('.fuse-vertical-navigation-content').css('color','black')
